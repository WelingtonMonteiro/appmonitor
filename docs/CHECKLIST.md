...
## Fase 4 — Alcance (stretch) — ✅ completa (v0.11.0–v0.13.0)
...
- [x] 🆕 **Regras de ação**: restart-on-down + "se mem ≥ N MB por M min → notifica/mata/reinicia" (edge-triggered, logado em Events). (v0.13.0)
